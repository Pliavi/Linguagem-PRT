...
{Delimiters}             : make_token(TokenChars, TokenLine). % autotoken for delimiters
{Symbols}                : make_token(TokenChars, TokenLine). %           and symbols
...
mak_token(CharsName, Line) ->
    {token, {CharsName, Line, CharsName}}.
